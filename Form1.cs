...
public partial class MainForm : Form
{
    ...
    private void button_CancelCustomer_Click(object sender, EventArgs e)
    {
        panel_Customer.Visible = false;
    }
    private void button_OkCustomer_Click(object sender, EventArgs e)
    {
        do
        {
    ...
    private void button_CancelCar_Click(object sender, EventArgs e)
    {
        panel_Car.Visible = false;
    }
    ...
    private void button_OkCar_Click(object sender, EventArgs e)
    {
        if (textBoxCar1.Text != "" || textBoxCar2.Text != "" || textBoxCar3.Text != "" || textBoxCar4.Text != "")
        {
    ...
    private void comboBox_Master_SelectedIndexChanged(object sender, EventArgs e)
    {
